...
class ShieldLocation {
  ...
  public static async initShield(
    ...
    await ShieldLocation.PlatformWrapper.initShield(
      config.siteID,
      config.secretKey,
      isOptimizedListener,
  ...
  public static async isSDKready(
    ...
    try {
      ...
      ShieldLocation.eventEmitter.addListener(
        "device_result_state",
  ...
  public static getLatestDeviceResult(): Promise<object> {
    return new Promise((resolve, reject) => {
      ShieldLocation.PlatformWrapper.getLatestDeviceResult(
        (result: object) => {

package com.shieldlocationplugin;
...
import com.shield.android.locationanalysis.modules.LocationCollectionModule; 
...
@ReactModule(name = ShieldLocationPluginModule.NAME)
public class ShieldLocationPluginModule extends ReactContextBaseJavaModule implements ShieldCallback<JSONObject> {
    public static final String NAME = "ShieldLocationPlugin";
    private final ReactApplicationContext reactContext;

    public ShieldLocationPluginModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void initShield(String siteID, String secretKey, Boolean isOptimizedListener, ReadableMap blockedDialog, Integer logLevel, Integer environment) {
        ...
        if (currentActivity != null) {
            ...
            LocationCollectionModule locationmodule = new LocationCollectionModule();
            builder.addModule(Collections.singletonList(locationmodule));

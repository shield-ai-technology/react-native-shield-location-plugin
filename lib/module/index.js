 ...
 */
export let EnvironmentInfo = /*#__PURE__*/function (EnvironmentInfo) {
...
class ShieldLocation {
   ...
   */
  static PlatformWrapper = NativeModules.ShieldLocationPlugin;

  /**
   * The event emitter for listening to success and error events.
   */
  static eventEmitter = new NativeEventEmitter(ShieldLocation.PlatformWrapper);
